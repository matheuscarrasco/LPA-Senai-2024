...
programa
{
	...
	funcao inicio()
	{
	//Os preços dos produtos são constantes
	...
	leia (qtd_refri)
		...
		/*
		 * Cáçculo dos valores a serem pagos
		 * O cálculo é feito multiplicanto a quantidades de itens vendidos pelo preço de cada item
		*/
